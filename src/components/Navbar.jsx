    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <a
          ...
          className="bg-primary text-white rounded-full px-5 py-2.5 text-sm font-semibold uppercase tracking-wide flex items-center gap-2 hover:bg-gray-800 hover:shadow-lg hover:scale-105 transition-all duration-300"
        >
          CV/RESUME →
        </a>
      </div>
